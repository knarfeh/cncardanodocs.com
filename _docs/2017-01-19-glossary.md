...
[节点](#节点)的唯一标示符。请阅读[卡尔达诺清算层的地址](/cardano/addresses/)获得更多信息。
...
卡尔达诺 SL (或者说卡尔达诺清算层) 是由 [IOHK](https://iohk.io/team) 设计和开发的去中心化加密货币. 为纪念 [Gerolamo Cardano](https://en.wikipedia.org/wiki/Gerolamo_Cardano) 而命名。
...
卡尔达诺清算层钱包应用。 它为用户提供一个用户界面, 用户可以管理，发送，收取资金等等。请阅读[卡尔达诺清算层钱包应用前端](/technical/wallet-frontend/) 获取更多信息。
